    ...
    <div id="home" ref={containerRef} className="relative h-auto lg:h-[200vh] w-full bg-saboroso-charcoal">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className="object-cover object-center scale-105 select-none brightness-[0.42] contrast-[1.12] saturate-[0.78] sepia-[0.08]"
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center min-h-[calc(100vh-5rem)]">
          ...
          <div className="lg:col-span-6 flex items-end justify-center relative h-[160px] xs:h-[220px] sm:h-[300px] lg:h-[600px] w-full mt-4 lg:mt-0 select-none">
            ...
            <div className="hidden lg:block absolute inset-0 z-0 pointer-events-none select-none">
              <div className="absolute left-[20%] bottom-[15%] w-[40%] aspect-square bg-[#155A25]/16 rounded-full filter blur-[110px] mix-blend-screen" />
              <div className="absolute left-[45%] bottom-[15%] w-[40%] aspect-square bg-[#7A0C11]/20 rounded-full filter blur-[110px] mix-blend-screen" />
              <div className="absolute left-[70%] bottom-[15%] w-[40%] aspect-square bg-[#C5A880]/14 rounded-full filter blur-[110px] mix-blend-screen" />
            </div>
            ...
            >
              <div className="relative w-full h-full animate-float flex justify-center items-center">
                <Image
                  ...
                  fill
                  className="object-contain drop-shadow-[0_10px_15px_rgba(0,0,0,0.5)] drop-shadow-[0_30px_60px_rgba(21,90,37,0.18)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10] scale-[1.3] lg:scale-[2.2] transition-all duration-300"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full animate-float-delayed flex justify-center items-center">
                <Image
                  ...
                  fill
                  className="object-contain drop-shadow-[0_15px_20px_rgba(0,0,0,0.55)] drop-shadow-[0_35px_70px_rgba(122,12,17,0.20)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10] scale-[1.3] lg:scale-[2.2] transition-all duration-300"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full animate-float-delayed-more flex justify-center items-center">
                <Image
                  ...
                  alt="Vinagre de Maçã"
                  fill
                  className="object-contain drop-shadow-[0_10px_15px_rgba(0,0,0,0.5)] drop-shadow-[0_30px_60px_rgba(197,168,128,0.18)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10] scale-[1.3] lg:scale-[2.2] transition-all duration-300"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full animate-float flex justify-center items-center">
                <Image
                  ...
                  alt="Vinagre de Limão"
                  fill
                  className="object-contain drop-shadow-[0_8px_10px_rgba(0,0,0,0.45)] drop-shadow-[0_20px_40px_rgba(21,90,37,0.18)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10]"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full animate-float-delayed flex justify-center items-center">
                <Image
                  ...
                  alt="Vinagre Tradicional"
                  fill
                  className="object-contain drop-shadow-[0_10px_12px_rgba(0,0,0,0.5)] drop-shadow-[0_25px_50px_rgba(122,12,17,0.20)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10] scale-110"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-full h-full animate-float-delayed-more flex justify-center items-center">
                <Image
                  ...
                  alt="Vinagre de Maçã"
                  fill
                  className="object-contain drop-shadow-[0_8px_10px_rgba(0,0,0,0.45)] drop-shadow-[0_20px_40px_rgba(197,168,128,0.18)] brightness-[0.83] contrast-[1.10] saturate-[0.86] sepia-[0.10]"
                />
              </div>
            </motion.div>
