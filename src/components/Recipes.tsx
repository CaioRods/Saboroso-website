      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {recipes.map((recipe, index) => (
            <motion.div
              key={recipe.title}
              className="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-xl border border-saboroso-gold/10 flex flex-col h-full group transition-all duration-300"
            ...
            >
              ...
              <div className="p-6 flex flex-col justify-between flex-grow">
                ...
                <a
                  href="#comercial"
                  className="inline-flex items-center gap-1.5 text-saboroso-red group-hover:text-saboroso-red-dark text-xs font-bold uppercase tracking-wider transition-colors"
                >
                  Ver Receita
